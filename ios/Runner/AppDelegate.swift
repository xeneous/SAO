...
@objc class AppDelegate: FlutterAppDelegate, PXLifeCycleProtocol {
  ...
  override func application(
    ...
    channelMercadoPago = FlutterMethodChannel(name: "canalNativo", binaryMessenger: flutterVC.binaryMessenger)
    initMethodChannel()
    ...
    func finishCheckout() -> ((_ payment: PXResult?) -> Void)? {
        return ({(_ payment: PXResult?) in
            ...
            let channelRespuestaMercadoPago = FlutterMethodChannel(name: "canalNativoRespuesta", binaryMessenger: self.flutterVC.binaryMessenger)
